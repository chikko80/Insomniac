    ...
    def interact_with_follower(follower_name, follower_name_view):
        ...
        if is_passed_filters is not None:
            ...
            should_continue, is_all_filters_satisfied = is_passed_filters(
                device, follower_name, reset=True, filters_tags=["BEFORE_PROFILE_CLICK"]
            )
        ...
        if is_passed_filters is not None:
            if not is_all_filters_satisfied:
                should_continue, _ = is_passed_filters(
                    device, follower_name, reset=False
                )
                if not should_continue:
        ...
        (
            ...
            LikeAction(
                source_name=username, source_type=source_type, user=follower_name
            ),
            session_state,
        )
        ...
        can_follow = (
            ...
            and storage.get_following_status(follower_name) == FollowingStatus.NONE
        ...
        if not can_interact:
            ...
            print_interaction_types(
                follower_name, can_like, can_follow, can_watch, can_comment
            )
            ...
            is_liked, is_followed, is_watch, is_commented = interaction(
                username=follower_name, interaction_strategy=interaction_strategy
            )
