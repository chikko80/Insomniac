...
class UnfollowActionRunner(CoreActionsRunner):
    ...
    def run(
        ...
        from insomniac.action_runners.unfollow.action_unfollow import (
            unfollow,
            get_unfollow_restriction,
        )

        unfollow_restriction = get_unfollow_restriction(
            self.unfollow_followed_by_anyone, self.unfollow_non_followers
        )
        ...
        def job():
            ...
            print(
                "Unfollowed "
                + str(session_state.totalUnfollowed)
                + " "
                + unfollow_restriction.value
                + ", finish."
            )
